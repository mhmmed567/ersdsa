...
import { User, Search, LogOut, ShoppingBag } from "lucide-react";
      ...
      <div className="container mx-auto flex flex-col gap-8">
        ...
        <div className="flex items-center justify-between">
          <Link href="/menu">
            <div className="flex items-center gap-4 bg-white/40 backdrop-blur-2xl pl-2 pr-6 py-2 rounded-full border border-white/40 shadow-[0_4px_20px_rgba(67,36,25,0.06)] hover:scale-105 transition-all duration-500">
               <div className="relative w-12 h-12 rounded-full overflow-hidden bg-[#432419] flex items-center justify-center shadow-lg shadow-[#432419]/20 group">
                 <span className="text-[#D48A5A] text-xl font-black italic group-hover:scale-110 transition-transform">D</span>
               </div>
               <div className="flex flex-col -gap-1">
                 <span className="text-2xl font-black text-[#432419] tracking-tighter leading-none">Diamond</span>
          ...
          <div className="flex gap-3">
            {/* Cart Button */}
            <Link href="/cart">
              <div className="relative w-14 h-14 rounded-2xl bg-white/40 backdrop-blur-md border border-white/40 shadow-sm flex items-center justify-center text-[#432419] hover:bg-white hover:scale-105 transition-all">
                <ShoppingBag className="h-6 w-6" />
                {cartCount > 0 && (
                  <span className="absolute -top-1 -right-1 bg-[#D48A5A] text-white text-[10px] w-5 h-5 rounded-full flex items-center justify-center font-black border-2 border-white">
                    {cartCount}
                  </span>
                )}
              </div>
